...
<head>
	...
	<title>Sewa.In | Admin Dashboard</title>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									?>	
										<tr>
											...
											<td><?php echo htmlentities($result['pickup_area']);?></td>
											<td><?php echo htmlentities($result['car_selection']);?></td>
											<td><?php echo htmlentities($result['phone']);?></td>
											<td><?php echo htmlentities($result['email']);?></td>
											<td><?php echo htmlentities($result['delivery_date']);?></td>
											<td><?php echo htmlentities($result['delivery_time']);?></td>
